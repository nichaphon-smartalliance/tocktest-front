    ...
    <Dropdown>
      <Dropdown.Trigger>
        <div
          ...
          className={`flex h-9 w-9 items-center justify-center rounded-lg cursor-pointer text-[var(--text-primary)] hover:bg-gray-100 dark:hover:bg-[#2a2d2e] transition-colors ${
